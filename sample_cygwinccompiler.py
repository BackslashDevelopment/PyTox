...
class Mingw32CCompiler(CygwinCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        self.set_executables(compiler='gcc -O -Wall -E -Wp,-v',
...
class Mingw64CCompiler(CygwinCCompiler):
    ...
    def __init__(self, verbose=0, dry_run=0, force=0):
        ...
        self.set_executables(compiler='x86_64-w64-mingw32-gcc  ' + include,
                             compiler_so='x86_64-w64-mingw32-gcc -mdll ' + include,
                             compiler_cxx='g++ -O -Wall',
